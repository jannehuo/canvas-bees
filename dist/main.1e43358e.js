...
},{"buffer":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Particle(id, x, y) {
    ...
    var points = this.randomPointFromCircle();
    this.spreadValues = {
      x: x + points.x,
      y: y + points.y
    };
  ...
  _createClass(Particle, [{
    ...
    key: "moveToPoint",
    value: function moveToPoint() {
      var relativeToMouse = this.getRelativeTo(this, mouse);
      var distance = this.getDistance(relativeToMouse);
      var direction = this.getDirection(relativeToMouse, distance);
      var force = this.getForce(distance);
    ...
    value: function spread() {
      ...
      var relativeToTarget = this.getRelativeTo(newPosition, this);
      var distance = this.getDistance(relativeToTarget);
      var direction = this.getDirection(relativeToTarget, distance);
      var force = this.getForce(distance);
      this.xVel += direction.x * force;
      this.yVel += direction.y * force;
    ...
    key: "getRelativeTo",
    value: function getRelativeTo(v1, v2) {
    ...
    key: "getDistance",
    value: function getDistance(relative) {
    ...
    key: "getDirection",
    value: function getDirection(relativeToTarget, distance) {
      if (distance === 0) {
        return {
          x: 0,
          y: 0
    ...
    key: "randomPointFromCircle",
    value: function randomPointFromCircle() {
      var radius = 200;
    ...
    key: "showTarget",
    value: function showTarget(newPosition) {
      context.beginPath();
...
function () {
  ...
  _createClass(Bees, [{
    key: "createBees",
    value: function createBees() {
      var _this = this;

      _lodash.default.times(this.size, function (i) {
        _this.bees.push(new Particle(i, screen.w / 2, screen.h / 2));
      });
    }
  }, {
    key: "draw",
    ...
    value: function move() {
      this.bees.forEach(function (bee) {
        return bee.setState('MOVING');
      });
    }
  }, {
    key: "updateSpreads",
    value: function updateSpreads() {
      this.bees.forEach(function (bee) {
        return bee.updateSpread();
      });
    }
  }]);
